...
export default function Filters({ onSaveFilter }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${import.meta.env.VITE_API_BASE_URL}/actors`)
  ...
  const handleLengthOpChange = (e) => {
    setLocalFilters({ ...localFilters, lengthOp: e.target.value });
  };
